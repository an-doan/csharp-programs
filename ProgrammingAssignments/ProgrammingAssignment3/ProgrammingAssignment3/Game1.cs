...
namespace ProgrammingAssignment3
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            //check if each rock is nul
            //if rock is not null, check if it is outside the window
            if (rock0 != null)
            {
            ...
            if (elapsedDelayMilliseconds >= TotalDelayMilliseconds)
            {
                ...
                //if a rock is null, get a random rock
                if (rock0 == null)
                {
                    rock0 = GetRandomRock();
                }
        ...
        private Texture2D GetRandomSprite()
        {
            ...
            // a random sprite using rand.Next, there are 3 options so 3 is the maxValue
        ...
        {
            // STUDENTS: Uncommment and modify the code below as appropriate to return 
            // a random velocity using rand.Next(), there are 4 options so the maxValue is 4
