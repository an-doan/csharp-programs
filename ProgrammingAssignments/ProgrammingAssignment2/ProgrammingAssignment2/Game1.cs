    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (elapsedTime > ChangeDelayTime)
            {
                ...
                {
                    currentSprite = enemy1;
                }
                else if (spriteNumber == 2)
                {
                    currentSprite = enemy2;
                }
            ...
            //add xSpeed and ySpeed to current x and y
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            //begin and end spriteBatch before/after drawing the object
            spriteBatch.Begin();

            //draw currentSprite using spriteBatch
